--[[
	...
	Author: LPGhatguy
	Repo: https://github.com/LPGhatguy/roblox-lua-promise
	License: CC0 <https://github.com/LPGhatguy/roblox-lua-promise/blob/master/LICENSE>

	Some modifications by Crazyman32

	---------------------------------------------------------------------------

	promise = Promise.new(func [, forceSpawn])
...
function Promise.new(callback, forceSpawn)
	local self = {
